...
choroLayer(
  ...
  breaks = c(-0.15,-0.10,-0.05, 0, 0.05, 0.1, 0.15, 0.2),
  method = "equal",
  nclass = 7,
  col = carto.pal(
    pal1 = "red.pal",
...
```{r}
choroLayer(mtq_2017, var = "taux_effort", breaks = c(0, 0.1, 0.2, 0.3, 0.4), method = "equal", nclass = 4, col = carto.pal(pal1 = "blue.pal", n1 = 4), border = "white", lwd = 0.5, legend.pos = "topright", legend.values.rnd = 3, legend.title.txt = "Taux Effort", add = TRUE)
